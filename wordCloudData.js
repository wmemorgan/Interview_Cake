 ...
 * Convert each word to lowercase and add to wordsToCounts
 * If word exits increment count
 * Else add
 *
*/
...
//     const separators = [' ', '...']      
//     for (let word of inputString.split(new RegExp(`[${separators.join('')}]`, 'g'))) {
//       // console.log(`word: ${word}`)
//       word = word.replace(/[^\w\s]/gi, '')
//       if (this.wordsToCounts.has(word.toLowerCase())) {
//         this.wordsToCounts.set(word, (this.wordsToCounts.get(word.toLowerCase()))+1)
//       } else {
//         this.wordsToCounts.set(word, 1)
//       }
//     }
